...
/***/ (function(module, exports) {
	...
	var setStorageTheme = function setStorageTheme() {
		sessionStorage.getItem('theme') === 'light' ? lightMode() : darkMode();
	};

	feather.replace();

	var sup = document.querySelector('.c-theme');
	...
	var changeMode = function changeMode() {
		var themeState = document.documentElement.hasAttribute('dark');
		themeState ? lightMode() : darkMode();
	};

	sup.addEventListener('click', changeMode);

	var navButton = document.querySelector('.c-mobile-nav');
	...
	var toggleMobileNav = function toggleMobileNav() {
		var navState = document.querySelector('.c-overlay');
		navState ? closeNav() : openNav();
	};

	navButton.addEventListener('click', toggleMobileNav);

	var resizeClose = function resizeClose() {
